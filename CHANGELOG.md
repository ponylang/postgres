...
- Update to work with ponyc 0.72.0 ([PR #260](https://github.com/ponylang/postgres/pull/260))

## [0.11.0] - 2026-09-07

### Changed

- SSLContext now comes from lori instead of ponylang/ssl ([PR #258](https://github.com/ponylang/postgres/pull/258))
- Update to work with ponyc 0.71.0 ([PR #259](https://github.com/ponylang/postgres/pull/259))

## [0.10.0] - 2026-09-05

### Changed

- Update to work with ponyc 0.70.1 ([PR #257](https://github.com/ponylang/postgres/pull/257))
...
- Drop support for Windows 10 ([PR #236](https://github.com/ponylang/postgres/pull/236))
...
- Require ponyc 0.64.0 or later ([PR #232](https://github.com/ponylang/postgres/pull/232))
...
- Validate DataRow column length before buffered read ([PR #225](https://github.com/ponylang/postgres/pull/225))
...
- Add composite type support ([PR #190](https://github.com/ponylang/postgres/pull/190))
