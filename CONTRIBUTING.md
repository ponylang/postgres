...
First of all please [search existing issues](https://github.com/ponylang/postgres/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/ponylang/postgres/issues/new).
...
If you feel overwhelmed at any point, don't worry, it can be a lot to learn when you get started. You can usually find us in the [Pony Zulip](https://ponylang.zulipchat.com/) if you need help.
