...
actor \nodoc\ Main is TestList
  ...
  fun tag tests(test: PonyTest) =>
    ...
    test(_TestProtocolViolationParseInSCRAM)
    test(_TestProtocolViolationParseInFlight)
    test(_TestProtocolViolationParseIdle)
    test(_TestProtocolViolationWrongStatePreAuth)
    test(_TestProtocolViolationWrongStateSCRAM)
    test(_TestProtocolViolationWrongStateIdle)
    test(_TestProtocolViolationWrongStateInFlight)
    test(_TestProtocolViolationCopyInInFlight)
    test(_TestProtocolViolationCopyOutInFlight)
    test(_TestProtocolViolationPrepareInFlight)
    test(_TestProtocolViolationStreamInFlight)
    test(_TestProtocolViolationPipelineInFlight)
    test(_TestProtocolViolationExtendedQueryInFlight)
    test(_TestProtocolViolationCloseStatementInFlight)
    test(_TestRemoteCloseSSLNegotiating)
    test(_TestRemoteClosePreAuth)
    test(_TestRemoteCloseSCRAM)
    test(_TestRemoteCloseLoggedInIdle)
    test(_TestRemoteCloseLoggedInInFlight)
    test(_TestRemoteCloseLoggedInPipeline)
    test(_TestRemoteCloseExtendedQueryInFlight)
    test(_TestRemoteClosePrepareInFlight)
    test(_TestRemoteCloseCopyInInFlight)
    test(_TestRemoteCloseCopyOutInFlight)
    test(_TestRemoteCloseStreamInFlight)
    test(_TestRemoteClosePostAuthPreReady)
    test(_TestRemoteCloseCloseStatementInFlight)
    test(_TestRemoteCloseAfterErrorResponse)
    test(_TestRemoteCloseSSLNegotiatingPreferred)
    ...
    test(_TestCodecRegistryWithEnumTypeRejectsBuiltinText)
    test(_TestCodecRegistryWithEnumTypeRejectsCustomTextCodec)
    test(_TestCodecRegistryWithEnumTypeRejectsCustomBinaryCodec)
    test(_TestCodecRegistryWithEnumTypeRejectsDuplicate)
    test(_TestCodecRegistryWithEnumTypeRejectsArrayOid)
    test(_TestCodecRegistryWithEnumTypeRejectsCustomArrayOid)
    test(_TestCodecRegistryWithEnumTypeChaining)
    test(_TestCodecRegistryWithEnumTypeHasBinaryCodec)
    test(_TestCodecRegistryWithEnumTypeBlocksWithCodec)
    test(_TestCodecRegistryWithEnumTypeBlocksWithArrayType)
    test(_TestCodecRegistryWithEnumTypeComposesWithArrayType)
    test(_TestCodecRegistryWithEnumTypeComposesArrayFirst)
    ...
    test(_TestCompositeCreate)
    test(_TestCompositeFromFields)
    test(_TestCompositeFromFieldsEmpty)
    test(_TestCompositeCreateValidation)
    test(_TestCompositeNamedAccessMiss)
    test(_TestCompositeEq)
    test(_TestCompositeFieldDataEq)
    test(_TestCompositeString)
    test(_TestCompositeRegistration)
    test(_TestCompositeRegistrationRejectsEmpty)
    test(_TestCompositeRegistrationRejectsExistingOid)
    test(_TestCompositeRegistrationRejectsEnumOid)
    test(_TestCompositeRegistrationRejectsArrayOid)
    test(_TestCompositeRegistrationRejectsSelfRef)
    test(_TestCompositeRegistrationRejectsDuplicate)
    test(_TestCompositeRegistrationBlocksWithCodec)
    test(_TestCompositeRegistrationBlocksWithEnumType)
    test(_TestCompositeRegistrationBlocksWithArrayType)
    test(_TestCompositeEqSizeMismatch)
    test(_TestCompositeEqWithNulls)
    test(_TestBinaryDecodeCompositeSimple)
    test(_TestBinaryDecodeCompositeWithNull)
    test(_TestBinaryDecodeCompositeNested)
    test(_TestBinaryDecodeCompositeFieldCountMismatch)
    test(_TestBinaryDecodeCompositeDepthGuard)
    test(_TestTextDecodeCompositeSimple)
    test(_TestTextDecodeCompositeWithNull)
    test(_TestTextDecodeCompositeEmptyString)
    test(_TestTextDecodeCompositeQuoted)
    test(_TestTextDecodeCompositeNested)
    test(_TestTextDecodeCompositeBackslash)
    test(_TestTextDecodeCompositeFieldCountMismatch)
    test(_TestTextDecodeCompositeNullFirst)
    test(_TestTextDecodeCompositeFewerFields)
    test(_TestCompositeEncoderSimple)
    test(_TestCompositeEncoderWithNull)
    test(_TestCompositeEncoderNested)
    test(_TestCompositeEncoderI16Roundtrip)
    test(_TestCompositeEncoderI64Roundtrip)
    test(_TestCompositeEncoderF32Roundtrip)
    test(_TestCompositeEncoderF64Roundtrip)
    test(_TestCompositeEncoderBoolRoundtrip)
    test(_TestCompositeEncoderByteaRoundtrip)
    test(_TestCompositeEncoderDateRoundtrip)
    ...
    test(_TestFrontendMessageBindWithComposite)
    test(_TestArrayWithCompositeElements)
    test(_TestCompositeWithArrayField)
    test(_TestFieldDataEqComposite)
    test(_TestCompositeUnregisteredFallback)
    test(_TestIntegrationCompositeSelectBinary)
    test(_TestIntegrationCompositeSelectText)
    test(_TestIntegrationCompositeRoundtrip)
