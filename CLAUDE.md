...
**Ports**: Mock server tests use ports in the 7669–7723 range and 9667–9668. **Port 7680 is reserved by Windows** (Update Delivery Optimization) and will fail to bind on WSL2 — do not use it. Composite integration tests don't use mock servers (they use the real PostgreSQL containers).
